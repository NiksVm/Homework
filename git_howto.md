...
Перемещение между ветками будет происходить путем ввода команды *git checkout <имя ветки>*. Чтобы вернутся к ветке _master_, пишем *git checkout master*
...
git merge <имя ветки>
```
В ветке в которой мы находимся срузу появится текст из ветки которую мы объединили.
