...
Для использования **полужирного** шрифта мы исползуем двойные знак '*' в конце и начале. Пример
```sh
**text**
```

Для использования *курсива* мы исползуем одинарные знак '*' в конце и начале. Пример
```sh
*text*
```


Для использования ~~зачеркнутого~~ мы исползуем двойной знак '~~' в конце и начале. Пример
```sh
~~text~~
```
